...
// Добавление класса для активного фильтра
const activeFilter = (event) => {
  const elem = event.currentTarget;
  elem.parentElement.querySelector('.filter-active') ? elem.parentElement.querySelector('.filter-active').classList.remove('filter-active') : '';
